...
class CetakTolakIzinBelajarController extends CI_Controller
{
    ...
    // generate PDF File
    public function tolakAjuIzinBelajar()
    {
        $data = array();
        $htmlContent = '';
        $id_izin_belajar = $this->input->GET('id');

        $data['info'] = $this->createpdf->getTolakAjuIzinBelajar($id_izin_belajar);
        $htmlContent = $this->load->view('template/cetak/tolak_izin_belajar', $data, TRUE);
