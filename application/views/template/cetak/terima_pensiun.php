	...
	<table border="">
	 ...
	 <h3 align="center">
		...
		<hr />
	 <h2 class="h5 mb-2 text-gray-800" align="center">Surat Tugas Pengambilan SK Pensiun</h2>
	 <table cellpadding="1">
		<tr>
			<td width="250"></td>
	...
	<br />
	<p align="left">Perihal : Pengambilan SK Pensiun</p>
	<br />
	<br />
	<p align="left">Dengan Hormat, </p>
	<br />
	<p align="justify">Menindaklanjuti surat permohonan pada tanggal <?php echo strftime('%d %B %Y', strtotime($result['tgl_pengajuan'])) ; ?> perihal permohonan pengajuan Pensiun, dengan ini diberitahukan bahwa 
	...
	<table cellpadding="3">
		...
		<tr>
			<td width="80"></td>
			<td width="150">TMT Pensiun </td>
			<td width="400" align="left">: <?php print $result['tmt_pensiun']; ?></td>
		</tr>
		<tr>
			<td width="80"></td>
	...
	<br/>
	<p align="left">Untuk mengambil SK Pensiun di Kantor Badan Kepegawaian dan Pengembangan Sumber Daya Manusia Kota Palembang </p>
	<br/>
