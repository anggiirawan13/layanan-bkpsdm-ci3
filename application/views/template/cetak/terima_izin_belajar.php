	...
	<br/>
	<p align="left">Untuk dibuatkan Surat Tugas Belajar jenjang pendidikan <?php print $result['jenjang_pendidikan']; ?> di <?php print $result['nama_instansi_pendidikan']; ?>, 
	dan telah disetujui dalam upaya peningkatan kualitas Sumber Daya Aparatur.</p>
	<br/>
	...
	<table cellpadding="3">
		...
		<tr>
			<td width="400"></td>
			<td width="200" align="left">Sekretaris Daerah</td>
			<td width="200" align="center"></td>
		</tr>
	</table>
	<table cellpadding="2">
	...
	<table cellpadding="3">
		<tr>
			<td width="400"></td>
			<td width="200" align="left">Drs. RATU DEWA, M.Si</td>
			<td width="200" align="center"></td>
		</tr>
		<tr>
			<td width="400"></td>
			<td width="200" align="left">NIP. 196907071993031005</td>
			<td width="200" align="center"></td>
		</tr>
	</table>
	<br/>
